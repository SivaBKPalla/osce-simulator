...
SEEDS: list[CaseSeed] = [
    ...
    CaseSeed(
        domain="viral-uri",
        titles=["A heavy cold that will not quit", "Cough and congestion after the office", "Runny nose and a scratchy throat"],
        complaints=["A bad cold", "Cough and runny nose", "Sore throat and congestion"],
        age_range=(16, 55),
        genders=["Female", "Male"],
        settings=["GP clinic", "Walk-in clinic"],
        diagnoses=["Viral upper respiratory infection", "Common cold", "Acute viral rhinosinusitis"],
        differentials=["Viral URI / common cold", "Influenza", "COVID-19", "Strep pharyngitis", "Acute sinusitis", "Early pneumonia"],
        next_steps=[
            "Reassure that this is likely viral and self-limited",
            "Supportive care: fluids, rest, saline rinse, honey or simple analgesia",
            "No routine antibiotics, CXR, or blood tests if no red flags",
            "Safety-net: return if dyspnea, chest pain, high fever after day 3, or symptoms last beyond 10 days",
            "Clinic follow-up only if not improving",
        ],
        hpi=[
            "Three days of runny nose, scratchy throat, and a dry cough after coworkers were ill. Eating and drinking well. No shortness of breath.",
            "Congestion and sneezing since yesterday, mild headache, still went to work. No chest pain.",
        ],
        associated=["Rhinorrhea", "Sore throat", "Mild cough"],
        negatives=["No dyspnea", "No pleuritic pain", "No confusion", "No high persistent fever"],
        pmh=["None", "Seasonal allergies"],
        meds=["Occasional loratadine", "None"],
        allergies=["NKDA"],
        family=["Non-contributory."],
        ros=["No ear pain.", "No wheeze."],
        teaching=[
            "Uncomplicated viral URI is a GP station: advice and safety-netting, not a septic workup.",
            "Ask red flags so pneumonia and influenza are reasonably excluded.",
        ],
        vitals_base=v(37.3, 82, "118/74", 16, 98, 2),
    ),
    CaseSeed(
        domain="asthma",
